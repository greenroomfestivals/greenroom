...
export function ScratchpadOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 flex h-[100dvh] w-full flex-col bg-background lg:static lg:z-auto lg:h-full lg:w-[50vw] lg:shrink-0 lg:border-l lg:border-border">
